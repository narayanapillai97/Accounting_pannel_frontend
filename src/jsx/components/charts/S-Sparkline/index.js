...
import "../../../../../src/css/sChartSparkline.css"; // Make sure this file exists

const sampleData = [
  64, 24, 40, 76, 19, 0, 2, 46, 65, 12, 10, 6, 15, 57, 35, 81,
  86, 12, 12, 21, 53, 44, 2, 1, 58, 9, 61, 64, 42, 92, 58, 9,
  34, 47, 89, 52, 3, 69, 33, 2, 60, 71, 71, 22, 65, 70, 31, 81, 36, 89,
];
    ...
    <>
      ...
      <Row>
        <Col xl={6} lg={6}>
          <Card className="s-card">
            <Card.Header className="s-card-header">
              <h4 className="s-card-title">Simple</h4>
            </Card.Header>
        ...
        <Col xl={6} lg={6}>
          <Card className="s-card">
            <Card.Header className="s-card-header">
              <h4 className="s-card-title">Simple Curve</h4>
            </Card.Header>
            <Card.Body className="s-card-body">
              <Sparklines data={sampleData}>
                <SparklinesLine color="#e23428" />
        ...
        <Col xl={6} lg={6}>
          <Card className="s-card">
            <Card.Header className="s-card-header">
              <h4 className="s-card-title">Spots</h4>
            </Card.Header>
            <Card.Body className="s-card-body">
              <Sparklines data={sampleData}>
        ...
        <Col xl={6} lg={6}>
          <Card className="s-card">
            <Card.Header className="s-card-header">
              <h4 className="s-card-title">Spots1</h4>
            </Card.Header>
            <Card.Body className="s-card-body">
              <Sparklines data={sampleData}>
        ...
        <Col xl={6} lg={6}>
          <Card className="s-card">
            <Card.Header className="s-card-header">
              <h4 className="s-card-title">Bars</h4>
            </Card.Header>
            <Card.Body className="s-card-body">
              <Sparklines
