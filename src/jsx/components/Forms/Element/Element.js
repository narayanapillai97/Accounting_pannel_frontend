...
const Element = () => {
  ...
  const [inlineSwitch1, setInlineSwitch1] = useState(false);
  const [inlineSwitch2, setInlineSwitch2] = useState(false);
  const [inlineSwitch3, setInlineSwitch3] = useState(false);
  ...
  return (
    <Fragment>
      ...
      <div className="row">
        ...
        <div className="col-xl-6 col-lg-6">
 <div className="s-card s-col-6">
          <div className="s-card-header">
            <h4 className="s-card-title">Switches</h4>
          </div>
          <div className="s-card-body">
            <div className="s-switch-group">
              <label className="s-switch">
                ...
                />
                <span className="s-slider"></span> Switch 1
              </label>
              <label className="s-switch">
                <input
                  type="checkbox"
                ...
                />
                <span className="s-slider"></span> Switch 2
              </label>
               <label className="s-switch">
                <input
                  type="checkbox"
                  ...
                  disabled
                />
                <span className="s-slider"></span> Switch 3 (Disabled)
              </label>
            </div>
          </div>
        </div>
 ...
 <div className="s-card s-col-6">
          <div className="s-card-header">
            <h4 className="s-card-title">Inline Switches</h4>
          </div>
          <div className="s-card-body">
            <div className="s-switch-inline">
              <label className="s-switch s-inline me-3">
                <input
                  type="checkbox"
                  checked={inlineSwitch1}
                  onChange={() => setInlineSwitch1(!inlineSwitch1)}
                />
                <span className="s-slider"></span> Inline 1
              </label>
              <label className="s-switch s-inline me-3">
                <input
                  type="checkbox"
                  checked={inlineSwitch2}
                  onChange={() => setInlineSwitch2(!inlineSwitch2)}
                />
                <span className="s-slider"></span> Inline 2
              </label>
               <label className="s-switch s-inline me-3">
                <input
                  type="checkbox"
                  checked={inlineSwitch3}
                  onChange={() => setInlineSwitch3(!inlineSwitch3)}
                  disabled
                />
                <span className="s-slider"></span> Inline 3
              </label>
            </div>
          </div>
        </div>
